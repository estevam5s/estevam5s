 ...
 * Location of images.
 */
export const GITHUB_CHESS_IMAGES_DIRECTORY_URL =
  "https://raw.githubusercontent.com/andyruwruw/andyruwruw/master/src/assets/images/";
 ...
 */
export const CHESS_COLORS: string[] = ["white", "black"];

/**
 * Chess pieces keys for piece images.
 */
export const CHESS_PIECES: string[] = ["b", "k", "n", "p", "q", "r"];
